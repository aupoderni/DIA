...
class DeepConv(torch.nn.Module):
    ...
    """
    def __init__(self, window_width, kernel_num,  bin_width, activation_fnc=torch.nn.functional.relu, spectrum_size=None, torch_device=None, torch_type=None):
        super(DeepConv,self).__init__()
        self.__class__.__name__ += '_'+activation_fnc.__class__.__name__
        self.window_width = int(window_width/bin_width)
